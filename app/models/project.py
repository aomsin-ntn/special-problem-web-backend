...
class Project(SQLModel, table=True):
    ...
    title_th: str | None = Field(max_length=500)
    title_en: str = Field(max_length=500)
    abstract_th: str | None = Field(sa_column=Column(Text))
    abstract_en: str = Field(sa_column=Column(Text))
    academic_year_be: str | None = Field(max_length=4)
    academic_year_ce: str = Field(max_length=4)
